    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 mb-8">
        ...
        <MetricCard
          icon={Clock}
          label="Avg Prep Time"
          value={`${analyticsData.summary.avgPrepTime} min`}
          color="purple"
        />
        <MetricCard
          icon={CheckCircle}
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          {item.count} orders • Avg: {item.avgPrepTime} min
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      ...
                      {slowestStage.avgTime} minutes. Consider reviewing this
                      workflow.
                    </p>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Peak hour is {analyticsData.summary.peakHour}. Ensure adequate
          ...
          {analyticsData.summary.parkedOrders > 0 ? (
            ...
            <div className="bg-white rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-gray-900">Great Performance</p>
                  <p className="text-sm text-gray-600 mt-1">
